...
Base instructions from the developer to the LLM.](#system-prompt)[## Messages

The full list of messages (conversation history) sent to the LLM.](#messages)[## Tools

Utilities the agent has access to for taking actions.](#tools)[## Model

The actual model (including configuration) to be called.](#model)[## Response Format

Schema specification for the model’s final response.](#response-format)
