...
Run sequentially at specific execution points.](#node-style-hooks)[## Wrap-style hooks

Run around each model or tool call.](#wrap-style-hooks)
...
Quick and simple for single-hook middleware. Use decorators to wrap individual functions.](#decorator-based-middleware)[## Class-based middleware

More powerful for complex middleware with multiple hooks or configuration.](#class-based-middleware)
...
### [](#working-with-system-messages) Working with system messages
